...
def train():
    ...
    with tf.Session(config=tf_config) as sess:
        ...
        train_set = read_data_into_buckets(data_processor.TRAIN_ENC_IDX_PATH, data_processor.TRAIN_DEC_IDX_PATH,
                                           data_processor.buckets)
        valid_set = read_data_into_buckets(data_processor.VAL_ENC_IDX_PATH, data_processor.VAL_DEC_IDX_PATH,
                                           data_processor.buckets)
        show_progress("done\n")
        ...
        # False for train
        beam_search = False
        model = create_or_restore_model(sess, data_processor.buckets, forward_only=False, beam_search=beam_search,
