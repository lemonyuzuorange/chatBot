...
# path list
SOURCE_PATH = cns.WORK_ROOT_PATH + "/data/TwitterSource.txt"
TARGET_PATH = cns.WORK_ROOT_PATH + "/data/TwitterTarget.txt"

TRAIN_ENC_PATH = cns.WORK_ROOT_PATH + "/generated/train_enc.txt"
VALIDATION_ENC_PATH = cns.WORK_ROOT_PATH + "/generated/validation_enc.txt"

TRAIN_DEC_PATH = cns.WORK_ROOT_PATH + "/generated/train_dec.txt"
VALIDATION_DEC_PATH = cns.WORK_ROOT_PATH + "/generated/validation_dec.txt"

VOCAB_ENC_PATH = cns.WORK_ROOT_PATH + "/generated/vocab_enc.txt"
VOCAB_DEC_PATH = cns.WORK_ROOT_PATH + "/generated/vocab_dec.txt"

TRAIN_ENC_IDX_PATH = cns.WORK_ROOT_PATH + "/generated/train_enc_idx.txt"
TRAIN_DEC_IDX_PATH = cns.WORK_ROOT_PATH + "/generated/train_dec_idx.txt"
VAL_ENC_IDX_PATH = cns.WORK_ROOT_PATH + "/generated/val_enc_idx.txt"
VAL_DEC_IDX_PATH = cns.WORK_ROOT_PATH + "/generated/val_dec_idx.txt"
LOGS_DIR = cns.WORK_ROOT_PATH + '/logs'
...
def create_train_validation(filepath, train_path, validation_path, train_ratio=0.9):
    ...
    with tf.gfile.GFile(filepath, "r") as f, tf.gfile.GFile(train_path, "w") as trf, tf.gfile.GFile(validation_path,
                                                                                                    "w") as vlf:
        for line in f:
            if counter < nb_train:
                trf.write(line)
